...
export default function AdminTaskTemplates() {
    ...
    const fetchTemplates = async () => {
        const res = await api.get('/api/admin/taskTemplates');
    ...
    const handleDelete = async (id: string) => {
        if (confirm('Are you sure you want to delete this task template?')) {
            await api.delete(`/api/admin/taskTemplates/${id}`);
            fetchTemplates();
        }
    };
...
function TemplateModal({ template, onClose, onSave }: {
    ...
    const handleSubmit = async () => {
        ...
        if (isEdit) {
            await api.put(`/api/admin/taskTemplates/${template!.id}`, form);
        } else {
            await api.post('/api/admin/taskTemplates', form);
        }
        onSave();
        onClose();
    };
