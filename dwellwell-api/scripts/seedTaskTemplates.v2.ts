//dwellwell-api/scripts/seedTaskTemplates.v2.ts
...
type Seed = {
  ...
  taskType?: any;          // enum via string literal
  criticality?: any;       // enum via string literal
  canDefer?: boolean;
...
async function ensureTemplate(s: Seed) {
  ...
  if (existing) {
    return prisma.taskTemplate.update({
      ...
      data: {
        ...
        taskType: (existing.taskType ?? s.taskType ?? 'GENERAL') as any,
        criticality: (existing.criticality ?? s.criticality ?? 'medium') as any,
        ...
        resources: ((existing as any).resources ?? s.resources ?? undefined) as any,
        state: 'VERIFIED' as any,
      },
    });
  }
  ...
  return prisma.taskTemplate.create({
    data: {
      ...
      taskType: (s.taskType ?? 'GENERAL') as any,
      criticality: (s.criticality ?? 'medium') as any,
      ...
      resources: (s.resources ?? undefined) as any,
      version: 1,
      state: 'VERIFIED' as any,
...
function mkSeed(p: Omit<Seed, "key"> & { key?: string }): Seed {
  const k =
    p.key ??
    `${keySlug(p.category ?? "home")}_${keySlug(p.title)}_${keySlug(
...
function roomPattern(
  ...
  return rooms.map((r) =>
    mkSeed({
      ...
      criticality: (base.criticality ?? 'low') as any,
...
function baseRoomHygiene(): Seed[] {
  ...
  return [
    ...
    ...common(
      "Inspect for pests or droppings",
      "1 month",
      5,
      "🐜",
      "Corners, under sinks, behind furniture."
    ),
...
function bathroomSet(): Seed[] {
  ...
  return [
    mkSeed({
      ...
      description: "Soak in vinegar to restore spray.",
    }),
    mkSeed({
      category: cat,
      title: "Deep-clean grout",
    ...
    mkSeed({
      category: cat,
      title: "Replace shower curtain liner",
      recurrenceInterval: "3 months",
      icon: "🧴",
    ...
    mkSeed({
      category: cat,
      title: "Check toilet flapper & supply line",
      recurrenceInterval: "6 months",
      icon: "🚽",
      estimatedTimeMinutes: 10,
    }),
...
function kitchenSet(): Seed[] {
  ...
  return [
    mkSeed({
      category: cat,
      title: "Clean garbage disposal (ice/lemon/baking soda)",
    ...
    mkSeed({
      category: cat,
      title: "Pull & clean behind refrigerator",
      recurrenceInterval: "6 months",
      icon: "🧯",
      estimatedTimeMinutes: 20,
    }),
    mkSeed({
      category: cat,
      title: "Clean stove underside & sides",
      recurrenceInterval: "6 months",
      icon: "🍳",
      estimatedTimeMinutes: 20,
    }),
    ...
    mkSeed({
      category: cat,
      title: "Pantry purge & wipe shelves",
      recurrenceInterval: "3 months",
      icon: "🥫",
    ...
    mkSeed({
      category: cat,
      title: "Check fridge/freezer temps (37°F/0°F)",
      recurrenceInterval: "1 month",
      icon: "🧊",
      estimatedTimeMinutes: 5,
    }),
...
function bedroomSet(): Seed[] {
  ...
  return [
    mkSeed({
      category: cat,
      title: "Wash pillows (or replace inserts)",
      recurrenceInterval: "3 months",
      icon: "🛏️",
      estimatedTimeMinutes: 30,
    }),
    mkSeed({
      category: cat,
      title: "Vacuum mattress & under bed",
      recurrenceInterval: "1 month",
      icon: "🧹",
      estimatedTimeMinutes: 15,
    }),
    mkSeed({
      category: cat,
      title: "Flip mattress (if flippable)",
      recurrenceInterval: "6 months",
      icon: "🔁",
      estimatedTimeMinutes: 10,
    }),
...
function livingRoomSet(): Seed[] {
  ...
  return [
    mkSeed({
      category: cat,
      title: "Vacuum upholstery & cushions",
      recurrenceInterval: "1 month",
      icon: "🛋️",
      estimatedTimeMinutes: 20,
    }),
    mkSeed({
      category: cat,
      title: "Clean TV/screen & dust media area",
      recurrenceInterval: "1 month",
      icon: "📺",
      estimatedTimeMinutes: 10,
    }),
    mkSeed({
      category: cat,
      title: "Rearrange furniture (prevent dents/fade)",
      recurrenceInterval: "6 months",
      icon: "🧭",
      estimatedTimeMinutes: 20,
    }),
    mkSeed({
      category: cat,
      title: "Fireplace ash cleanout (in season)",
...
function laundrySet(): Seed[] {
  ...
  return [
    mkSeed({
      category: cat,
      title: "Inspect washer hoses & replace if bulging",
      recurrenceInterval: "1 year",
      icon: "🪢",
      estimatedTimeMinutes: 10,
...
function basementSet(): Seed[] {
  ...
  return [
    mkSeed({
      category: cat,
      title: "Run dehumidifier / clean filter",
      recurrenceInterval: "1 month",
      icon: "💧",
      estimatedTimeMinutes: 10,
    }),
    mkSeed({
      category: cat,
      title: "Check for efflorescence/leaks",
      recurrenceInterval: "3 months",
      icon: "🧱",
      estimatedTimeMinutes: 10,
    }),
    mkSeed({
      ...
      icon: "🕳️",
      estimatedTimeMinutes: 10,
      steps: ["Lift float or pour water into pit", "Verify discharge outdoors"],
    }),
  ];
}
...
function garageSet(): Seed[] {
  ...
  return [
    mkSeed({
      category: cat,
      title: "Clean door tracks & lube rollers",
      recurrenceInterval: "6 months",
      icon: "🚪",
      estimatedTimeMinutes: 15,
    ...
    mkSeed({
      category: cat,
      title: "Test auto-reverse safety",
      recurrenceInterval: "6 months",
      icon: "⚠️",
      estimatedTimeMinutes: 5,
      criticality: 'high' as any,
    ...
    mkSeed({
      category: cat,
      title: "Sweep & declutter floor zones",
      recurrenceInterval: "1 month",
      icon: "🧹",
      estimatedTimeMinutes: 15,
    }),
...
function atticSet(): Seed[] {
  ...
  return [
    mkSeed({
      category: cat,
      title: "Inspect insulation & ventilation",
      recurrenceInterval: "1 year",
      icon: "🪵",
      estimatedTimeMinutes: 20,
    }),
    ...
    mkSeed({
      category: cat,
      title: "Scan for roof leaks after rain",
      recurrenceInterval: "3 months",
      icon: "🌧️",
      estimatedTimeMinutes: 10,
    }),
...
function hvacSet(): Seed[] {
  ...
  return [
    mkSeed({
      category: cat,
      title: "Service visit (professional inspection)",
      recurrenceInterval: "1 year",
      icon: "🧑‍🔧",
    ...
    mkSeed({
      category: cat,
      title: "Clean outdoor unit fins & clear debris",
      recurrenceInterval: "6 months",
      icon: "🪣",
      estimatedTimeMinutes: 20,
    }),
    mkSeed({
      category: cat,
      title: "Flush condensate line (bleach/vinegar)",
      recurrenceInterval: "3 months",
      icon: "🧪",
      estimatedTimeMinutes: 10,
    }),
    mkSeed({
      category: cat,
      title: "Vacuum registers & returns",
      recurrenceInterval: "3 months",
      icon: "🌀",
      estimatedTimeMinutes: 15,
    }),
...
function plumbingSet(): Seed[] {
  ...
  return [
    mkSeed({
      category: cat,
      title: "Drain water heater sediment",
      recurrenceInterval: "1 year",
      icon: "🔥",
      estimatedTimeMinutes: 45,
      canBeOutsourced: true,
...
function electricalSet(): Seed[] {
  ...
  return [
    ...
    mkSeed({
      category: cat,
      title: "Visual panel inspection (labels, rust, smells)",
      recurrenceInterval: "1 year",
      icon: "🧲",
      estimatedTimeMinutes: 10,
      canBeOutsourced: true,
    ...
    mkSeed({
      category: cat,
      title: "Replace smoke/CO units at end-of-life",
      recurrenceInterval: "10 years",
      icon: "🚨",
      estimatedTimeMinutes: 15,
      criticality: 'high' as any,
    }),
...
function exteriorSet(): Seed[] {
  ...
  return [
    mkSeed({
      category: cat,
      title: "Pressure-wash siding (gentle settings)",
      recurrenceInterval: "1 year",
      icon: "🧽",
      estimatedTimeMinutes: 60,
      canBeOutsourced: true,
    ...
    mkSeed({
      category: cat,
      title: "Inspect deck boards/rails/fasteners",
      recurrenceInterval: "1 year",
      icon: "🪵",
      estimatedTimeMinutes: 30,
    }),
    mkSeed({
      category: cat,
      title: "Seal/stain deck",
      recurrenceInterval: "2 years",
      icon: "🧴",
    ...
    mkSeed({
      category: cat,
      title: "Clean and realign downspouts",
      recurrenceInterval: "6 months",
      icon: "💧",
      estimatedTimeMinutes: 15,
    }),
...
function windowsDoorsSet(): Seed[] {
  ...
  return [
    ...
    mkSeed({
      category: cat,
      title: "Clean and re-caulk exterior trim",
      recurrenceInterval: "1 year",
      icon: "🧴",
      estimatedTimeMinutes: 60,
      canBeOutsourced: true,
    ...
    mkSeed({
      category: cat,
      title: "Replace door sweeps/weatherstripping",
      recurrenceInterval: "1 year",
      icon: "🌬️",
      estimatedTimeMinutes: 15,
    }),
...
function deckPatioSet(): Seed[] {
  ...
  return [
    mkSeed({
      category: cat,
      title: "Sweep debris and clear gaps",
      recurrenceInterval: "1 month",
      icon: "🧹",
      estimatedTimeMinutes: 10,
    }),
    mkSeed({
      category: cat,
      title: "Check railings & steps for wobble",
      recurrenceInterval: "6 months",
      icon: "🪛",
      estimatedTimeMinutes: 10,
    }),
...
function yardSet(): Seed[] {
  ...
  return [
    ...
    mkSeed({
      category: cat,
      title: "Prune shrubs/trees (non-flowering)",
      recurrenceInterval: "1 year",
      icon: "✂️",
      estimatedTimeMinutes: 45,
      canBeOutsourced: true,
...
function pestSet(): Seed[] {
  ...
  return [
    mkSeed({
      category: cat,
      title: "Perimeter inspection & seal gaps",
      recurrenceInterval: "1 month",
      icon: "🕳️",
      estimatedTimeMinutes: 15,
    }),
    mkSeed({
      category: cat,
      title: "Set/inspect traps where activity noted",
      recurrenceInterval: "1 week",
      icon: "🐭",
      estimatedTimeMinutes: 5,
    }),
...
function roofSet() {
  // reserved (intentionally blank for now)
}
...
function seasonalSet(): Seed[] {
  ...
  return [
    mkSeed({
      category: cat,
      title: "Spring: test sump, clean gutters, tune mower",
      recurrenceInterval: "1 year",
      icon: "🌼",
      estimatedTimeMinutes: 90,
      resources: { bundle: ["sump", "gutters", "mower"] },
    }),
    mkSeed({
      category: cat,
      title: "Fall: blow out sprinklers, winterize faucets",
      recurrenceInterval: "1 year",
      icon: "🍂",
      estimatedTimeMinutes: 60,
      criticality: 'high' as any,
    ...
    mkSeed({
      category: cat,
      title: "Winter: clear dryer vent, salt/sand on hand",
      recurrenceInterval: "1 year",
      icon: "❄️",
      estimatedTimeMinutes: 30,
    }),
    mkSeed({
      category: cat,
      title: "Summer: inspect deck & outdoor play gear",
      recurrenceInterval: "1 year",
      icon: "☀️",
      estimatedTimeMinutes: 30,
    }),
